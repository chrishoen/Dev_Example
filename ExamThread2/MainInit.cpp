...
{
   printf("ExamThread2 Program********************************************BEGIN\n");
   printf("ExamThread2 Program********************************************BEGIN\n");
   printf("ExamThread2 Program********************************************BEGIN\n\n");
   ...
   //***************************************************************************
   //***************************************************************************
   Prn::print(Prn::View11, "ExamThread2 Program********************************************BEGIN");
}
...
void main_finalize()
{
   Prn::print(Prn::View11, "ExamThread2 Program********************************************END");
   printf("\n");
   printf("ExamThread2 Program********************************************END\n");
   printf("ExamThread2 Program********************************************END\n");
   printf("ExamThread2 Program********************************************END\n");
