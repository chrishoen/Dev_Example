...
function(my_lib_import_RisLib _target)
   ...
   if (MSVC)
      set (MyRisLibImportPath  "C:/ProgramData/MyLib/lib/RisLib.lib")
   elseif (MYMODE STREQUAL "prime-arm7")
      set (MyRisLibImportPath  "C:/ProgramData/MyLib/lib/RisLib.a")
...
function(my_inc_import_RisLib _target)
   ...
   if (MSVC OR MYMODE STREQUAL "prime-arm7")
      set (MyRisLibIncludePath "C:/ProgramData/MyLib/include/RisLib")
   else()
